...
image = love.graphics.newImage('bird.png')
variable = image:getHeight()
...
function PipePair:init(y)
    ...
    self.pipes = {
        ...
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + math.random(variable + 45, 220))
    }
