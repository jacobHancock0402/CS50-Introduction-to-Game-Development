...
public class HeliController : MonoBehaviour {
	...
	void Update () {
		...
		// vertical axis is either up or down or w and s on the keyboard, a***REMOVED*** others
		...
		// horizontal axis is either left or right or a and d on the keyboard, a***REMOVED*** others
