...
function AlienLaunchMarker:update(dt)
    ...
    if not self.launched then
        ...
        elseif love.mouse.wasReleased(1) and self.aiming then
            ...
            Alien1 = Alien(self.world, 'round', self.shiftedX, self.shiftedY, 'Player')
            Alien1.spawned = true
            ...
            for k, alien in pairs(self.alien) do
                if alien.spawned then
                    ...
                    elseif k == 2 then
                        alien.body:setLinearVelocity((self.baseX - self.shiftedX) * 1, (self.baseY - self.shiftedY) * 20)
                    else 
                        alien.body:setLinearVelocity((self.baseX - self.shiftedX) * 1, (self.baseY - self.shiftedY) * 30)
                    end
                end
