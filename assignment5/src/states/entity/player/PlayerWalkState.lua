...
function PlayerWalkState:update(dt)
    if not self.entity.carrying then
        ...
        -- maybe animations aren't included in defs for entity
    else
        --if love.keyboard.wasPressed('enter') then
           -- maybe can't use direction like this, also how get it to start after this ani stops
           -- maybe have throw add in in diff or some
        self.entity:changeAnimation('lift-up') --.. tostring(self.entity.direction))
